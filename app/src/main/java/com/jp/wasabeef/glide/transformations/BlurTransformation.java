...
public class BlurTransformation implements Transformation<Bitmap> {
    ...
    private static int defaultDownSimpling = 1;
    ...
    public BlurTransformation(Context context) {
        this(context, Glide.get(context).getBitmapPool(), maxRadius, defaultDownSimpling);
    }

    public BlurTransformation(Context context, BitmapPool pool) {
        this(context, pool, maxRadius, defaultDownSimpling);
    }

    public BlurTransformation(Context context, BitmapPool pool, int radius) {
        this(context, pool, radius, defaultDownSimpling);
    }

    public BlurTransformation(Context context, int radius) {
        this(context, Glide.get(context).getBitmapPool(), radius, defaultDownSimpling);
    }
